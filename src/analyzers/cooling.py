...
def analyze_cooling(df: pd.DataFrame) -> list[Insight]:
    ...
    for miner_id, grp in df.groupby("miner_id"):
            ...
            insights.append(
                {
                    ...
                    "severity": "critical"
                    if worst_change > PRESSURE_CRITICAL_CHANGE
                    else "warning",
                    "detail": (
        ...
        degradation = (immersion_trend > COOLING_TEMP_RISE_RATE) & (
            ...
            insights.append(
                {
                    ...
                    "metric": count,
                    "action": (
                        "Inspect heat exchanger fouling, coolant quality, and ambient conditions."
                    ),
                }
            )
        ...
        cooling_effort = (immersion_trend < -COOLING_TEMP_RISE_RATE) & (
            ...
            insights.append(
                {
                    ...
                    "action": (
                        "Inspect thermal interface, fluid flow rate, and immersion fluid quality."
                    ),
                }
            )
